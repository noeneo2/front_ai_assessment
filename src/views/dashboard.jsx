...
const handleCopyShareLink = async () => {
  if (!reportData || !reportData.share_token) {
    alert('No se pudo obtener el enlace compartible.');
    return;
  }

  try {
    const shareUrl = `${window.location.origin}/share/${reportData.share_token}`;
          ...
          <div className="home-header-dashboard">
            <div className="home-header-frame">
              ...
              <div className="home-header-2">
                ...
                <div className="home-frame15" onClick={handleDownloadPDF} style={{ cursor: downloadingPDF ? 'wait' : 'pointer', opacity: downloadingPDF ? 0.6 : 1 }}>
                  <img src="/external/icondownload4611-c77h.svg"
                    alt="Icondownload"
                    className="home-icondownload"
                  />
                  <span className="home-text12">{downloadingPDF ? 'Generando PDF...' : 'Descargar PDF'}</span>
                </div>

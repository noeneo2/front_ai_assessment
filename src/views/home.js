...
const Home = (props) => {
  return (
    <div className="home-container1">
      <Helmet>
        <title>Blond Relieved Barracuda</title>
        <meta property="og:title" content="Blond Relieved Barracuda" />
      </Helmet>
              ...
              <div className="home-header-frame">
                <div className="home-titleand-status-container">
                  ...
                  <div className="home-frame1321316829">
                    ...
                    <img
                      src="/external/iconrefresh4628-tqwi.svg"
                      alt="Iconrefresh4628"
                      className="home-iconrefresh"
                    />
                  </div>
                </div>
                <div className="home-frame15">
                  <img
                    src="/external/icondownload4628-sqmy.svg"
                    alt="Icondownload4628"
              ...
              <div className="home-main-content2">
                <div className="home-frame1321316835">
                  <div className="home-frame1321316837">
                    <div className="home-frame1321316836">
                      <div className="home-group15">
                        <img
                          src="/external/rectangle94630-9vru-200h.png"
                          alt="Rectangle94630"
                          className="home-rectangle9"
                        />
                      </div>
                      <span className="home-text17">2.92</span>
                      <div className="home-group17">
                        <div className="home-group16"></div>
                      </div>
                    </div>
                  </div>
                  <div className="home-score">
                    ...
                    <span className="home-text19">
                      La empresa define una estrategia clara para la GenAI,
                      identifica áreas prioritarias y empieza a integrar
                      herramientas en procesos específicos. Se establecen
                      políticas de uso responsable y se inician proyectos
                      piloto.
                    </span>
                  </div>
                </div>
                <div className="home-graphic-explanation">
                  ...
                  <div className="home-indicator">
                    <span className="home-text29">Tu score</span>
                    <img
                ...
                <div className="home-scores-categories">
                  <div className="home-container3">
                    <span className="home-text34">
                      Puntuación de madurez por áreas
                    </span>
                    <div className="home-frame1321316812">
                      <div className="home-frame1321316815">
                        <div className="home-frame1321316813">
                          <div className="home-card-sub-score1">
                            <div className="home-number-card1">
                              ...
                              <div className="home-numberdetail1">
                                <div className="home-frame13213168111">
                                  <span className="home-text36">2.84</span>
                          ...
                          <div className="home-card-sub-score2">
                            <div className="home-number-card2">
                              <span className="home-text39">Governance</span>
                              <div className="home-numberdetail2">
                                <div className="home-frame13213168112">
                                  <span className="home-text40">2.23</span>
                                  <div className="home-frame13213168302">
                                    <span className="home-text41">+10%</span>
                                  </div>
                                </div>
                          ...
                          <div className="home-card-sub-score3">
                            <div className="home-number-card3">
                              <span className="home-text43">
                                Data &amp; Tecnología
                              </span>
                              <div className="home-numberdetail3">
                                <div className="home-frame13213168113">
                                  <span className="home-text44">3.43</span>
                                  <div className="home-frame13213168303">
                                    <span className="home-text45">+13%</span>
                                  </div>
                                </div>
                        ...
                        <div className="home-frame1321316814">
                          <div className="home-card-sub-score4">
                            <div className="home-number-card4">
                              <span className="home-text47">Procesos</span>
                              <div className="home-numberdetail4">
                                <div className="home-frame13213168114">
                                  <span className="home-text48">2.22</span>
                                  <div className="home-frame13213168304">
                                    <span className="home-text49">+2%</span>
                                  </div>
                                </div>
                          ...
                          <div className="home-card-sub-score5">
                            <div className="home-number-card5">
                              <span className="home-text51">Proyectos</span>
                              <div className="home-numberdetail5">
                                <div className="home-frame13213168115">
                                  <span className="home-text52">2.32</span>
                                  <div className="home-frame13213168305">
                          ...
                          <div className="home-card-sub-score6">
                            <div className="home-number-card6">
                              <span className="home-text55">Estrategia</span>
                              <div className="home-numberdetail6">
                                <div className="home-frame13213168116">
                                  <span className="home-text56">1.24</span>
                                  <div className="home-frame13213168306">
                                    <span className="home-text57">-2%</span>
                                  </div>
                                </div>
                ...
                <div className="home-frame1321316826">
                  ...
                  <div className="home-accordion-list">
                    <div className="home-accordion-item1">
                      ...
                      <div className="home-answer">
                        <span className="home-text61">
                          La organización reconoce el potencial de la GenAI y
                          empieza a explorar casos de uso básicos. Hay
                          curiosidad y pruebas iniciales, pero sin una
                          estrategia formal ni recursos dedicados.
                        </span>
                      </div>
                    </div>
                    <div className="home-accordion-item2">
                      <div className="home-question2">
                        <span className="home-text62">
                          Estrategia, Adopción e Integración
                        </span>
                        <img
                          src="/external/icon4639-4crm.svg"
                          alt="Icon4639"
                          className="home-icon2"
                        />
                      </div>
                    </div>
                    <div className="home-accordion-item3">
                      <div className="home-question3">
                        <span className="home-text63">
                          Escalamiento y Optimización
                        </span>
                        <img
                          src="/external/icon4639-sumf.svg"
                          alt="Icon4639"
                          className="home-icon3"
                        />
                      </div>
                    </div>
                    <div className="home-accordion-item4">
                      <div className="home-question4">
                        <span className="home-text64">Transformación</span>
                        <img
                          src="/external/icon4640-kaxi.svg"
                          alt="Icon4640"
            ...
            <div className="home-page-links">
              <div className="home-logos">
                <div className="home-logo">
                  <div className="home-logonegro-neo1">
                    <div className="home-clippathgroup">
                      <div className="home-clip0570710460">
                        <img
                          src="/external/vectori466-1jd.svg"
                          alt="VectorI466"
                      ...
                      <div className="home-group">
                        <img
                          src="/external/vectori466-lxzm.svg"
                          alt="VectorI466"
                          className="home-vector3"
                        />
                        <img
                          src="/external/vectori466-3gw.svg"
                          alt="VectorI466"
                          className="home-vector4"
                        />
                        <img
                          src="/external/vectori466-suhn.svg"
                          alt="VectorI466"
                          className="home-vector5"
                        />
                        <img
                          src="/external/vectori466-2536.svg"
                          alt="VectorI466"
                          className="home-vector6"
                        />
                        <img
                          src="/external/vectori466-tbio.svg"
                          alt="VectorI466"
              ...
              <div className="home-footer-link-column">
                <span className="home-text101">Neo Consulting. 2025</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <a href="https://play.teleporthq.io/signup" className="home-link">
        <div aria-label="Sign up to TeleportHQ" className="home-container5">
          ...
          <span className="home-text102">Built in TeleportHQ</span>
        </div>
      </a>
    </div>
  )

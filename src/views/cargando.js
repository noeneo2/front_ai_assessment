...
const Page1 = (props) => {
  return (
    <div className="page1-container1">
      ...
      <a href="https://play.teleporthq.io/signup" className="page1-link">
        <div aria-label="Sign up to TeleportHQ" className="page1-container2">
          <svg
            width="24"
            height="24"
            viewBox="0 0 19 21"
          ...
          <span className="page1-text3">Built in TeleportHQ</span>
        </div>
      </a>
    </div>
  )
